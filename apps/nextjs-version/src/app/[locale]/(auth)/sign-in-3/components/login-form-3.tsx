  ...
  return (
    <div className={cn("flex flex-col gap-6", className)} {...props}>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                ...
                >
                  ...
                  <span className="sr-only">{t("loginApple")}</span>
                </Button>
                <Button
                  variant="outline"
                  type="button"
                ...
                >
                  ...
                  <span className="sr-only">{t("loginGoogle")}</span>
                </Button>
                <Button
                  variant="outline"
                  type="button"
                ...
                >
                  ...
                  <span className="sr-only">{t("loginMeta")}</span>
                </Button>
              </div>
      ...
      <div className="text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
        {t("continueAgreement")} <Link href="#">{t("termsOfService")}</Link>{" "}
